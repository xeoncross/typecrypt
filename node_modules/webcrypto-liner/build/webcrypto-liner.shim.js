...
var liner = (function (exports, asmcrypto_js, elliptic) {
            ...
            while (1) {
              switch (_context20.prev = _context20.next) {
                case 0:
                  ...
                  algorithm = args[0], extractable = args[1], keyUsages = args[2];
                  preparedAlgorithm = this.prepareAlgorithm(algorithm);
                  provider = this.getProvider(preparedAlgorithm.name);
                  _context20.next = 7;
            ...
            while (1) {
              switch (_context21.prev = _context21.next) {
                case 0:
                  ...
                  algorithm = args[0], key = args[1], data = args[2];
                  this.checkCryptoKey(key);
                  preparedAlgorithm = this.prepareAlgorithm(algorithm);
                  preparedData = BufferSourceConverter.toArrayBuffer(data);
                  provider = this.getProvider(preparedAlgorithm.name);
            ...
            while (1) {
              switch (_context22.prev = _context22.next) {
                case 0:
                  ...
                  algorithm = args[0], key = args[1], signature = args[2], data = args[3];
                  this.checkCryptoKey(key);
                  preparedAlgorithm = this.prepareAlgorithm(algorithm);
                  preparedData = BufferSourceConverter.toArrayBuffer(data);
            ...
            while (1) {
              switch (_context25.prev = _context25.next) {
                case 0:
                  ...
                  algorithm = args[0], baseKey = args[1], length = args[2];
            ...
            while (1) {
              switch (_context26.prev = _context26.next) {
                case 0:
                  ...
                  algorithm = args[0], baseKey = args[1], derivedKeyType = args[2], extractable = args[3], keyUsages = args[4];
            ...
            while (1) {
              switch (_context28.prev = _context28.next) {
                case 0:
                  ...
                  format = args[0], keyData = args[1], algorithm = args[2], extractable = args[3], keyUsages = args[4];
                  preparedAlgorithm = this.prepareAlgorithm(algorithm);
                  provider = this.getProvider(preparedAlgorithm.name);
  ...
  function concat() {
    for (var _len22 = arguments.length, buf = new Array(_len22), _key24 = 0; _key24 < _len22; _key24++) {
      buf[_key24] = arguments[_key24];
    }
  ...
  var Debug = function () {
    ...
    _createClass(Debug, null, [{
      ...
      value: function log() {
        if (this.enabled) {
          for (var _len23 = arguments.length, args = new Array(_len23), _key25 = 0; _key25 < _len23; _key25++) {
    ...
    var EcCrypto = function () {
      ...
      _createClass(EcCrypto, null, [{
        ...
        value: function concat() {
          for (var _len28 = arguments.length, buf = new Array(_len28), _key30 = 0; _key30 < _len28; _key30++) {
            buf[_key30] = arguments[_key30];
          }
